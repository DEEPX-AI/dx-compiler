---
name: dx-agentic-compiler-compile
description: ONNX to DXNN compilation workflow for dx-compiler
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/skills/dx-agentic-compiler-compile/SKILL.md -->
<!-- Run: dx-agentic-gen generate -->

# /dx-agentic-compiler-compile — ONNX to DXNN Compilation Skill
...
> reference files from previous sessions in `dx-agentic-dev/`. Even if a
> previous session downloaded or exported the exact same model, always
> re-download and re-export from scratch. Do NOT run `ls dx-agentic-dev/`
...
1. **Identify** the model's official download source:
   ...
   - If the source model is PyTorch (`.pt`/`.pth`), route to `/dx-agentic-compiler-convert`
...
> directory — never reuse or reference artifacts from `dx-agentic-dev/` past runs.
