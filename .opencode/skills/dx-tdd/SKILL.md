---
name: dx-tdd
description: "Test-driven development for dx-compiler. Iron Law: no compilation step without validation check first."
---

# /dx-tdd — Test-Driven Development for dx-compiler
