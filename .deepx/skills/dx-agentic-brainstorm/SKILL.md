...
# /dx-agentic-brainstorm — Brainstorm & Plan Before Compilation
...
2. [ ] <if PyTorch> Convert to ONNX → /dx-agentic-compiler-convert
...
6. [ ] Compile ONNX → DXNN → /dx-agentic-compiler-compile
7. [ ] Validate output → /dx-agentic-compiler-validate
8. [ ] Generate session report

**Routing**: /dx-agentic-compiler-convert → /dx-agentic-compiler-compile → /dx-agentic-compiler-validate
```
...
1. **PyTorch input** → `/dx-agentic-compiler-convert`
2. **ONNX ready** → `/dx-agentic-compiler-compile`
3. **Always** → `/dx-agentic-compiler-validate`
